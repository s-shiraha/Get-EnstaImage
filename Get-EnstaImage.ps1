...
$ImagePath = "${HOME}\pwsh\image_and_csv\nazuna3.png"
...
Add-Content -Path $OutCsvPath -Value $OutStr -Encoding UTF8
...
Add-Content -Path $OutCsvPath -Value "" -Encoding UTF8
Get-Content -Path $OutCsvPath -Encoding UTF8 | `
    Select-Object -Skip 1 | `
        ForEach-Object -Process {($_ -split ",")[1..128]} | `
            Group-Object -NoElement | `
                Sort-Object -Property Count | `
                    ForEach-Object -Process {
                        Add-Content -Path $OutCsvPath -Value " ,$($_.Name),$($_.Count)" -Encoding UTF8
                    }
