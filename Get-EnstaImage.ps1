...
function MinecraftBlocks {
    ...
    $Ret.Add(@{"草ブロック(標)" = @{"R" = [math]::Floor(127 * 220 / 255); "G" = [math]::Floor(178 * 220 / 255); "B" = [math]::Floor(56 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"砂(標)" = @{"R" = [math]::Floor(247 * 220 / 255); "G" = [math]::Floor(233 * 220 / 255); "B" = [math]::Floor(163 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"TNT(標)" = @{"R" = [math]::Floor(255 * 220 / 255); "G" = [math]::Floor(0 * 220 / 255); "B" = [math]::Floor(0 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"白色の羊毛(標)" = @{"R" = [math]::Floor(255 * 220 / 255); "G" = [math]::Floor(255 * 220 / 255); "B" = [math]::Floor(255 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"土(標)" = @{"R" = [math]::Floor(151 * 220 / 255); "G" = [math]::Floor(109 * 220 / 255); "B" = [math]::Floor(77 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"丸石(標)" = @{"R" = [math]::Floor(112 * 220 / 255); "G" = [math]::Floor(112 * 220 / 255); "B" = [math]::Floor(112 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"作業台(標)" = @{"R" = [math]::Floor(143 * 220 / 255); "G" = [math]::Floor(119 * 220 / 255); "B" = [math]::Floor(72 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"橙色の羊毛(標)" = @{"R" = [math]::Floor(216 * 220 / 255); "G" = [math]::Floor(127 * 220 / 255); "B" = [math]::Floor(51 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"赤紫色の羊毛(標)" = @{"R" = [math]::Floor(178 * 220 / 255); "G" = [math]::Floor(76 * 220 / 255); "B" = [math]::Floor(216 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"空色の羊毛(標)" = @{"R" = [math]::Floor(102 * 220 / 255); "G" = [math]::Floor(153 * 220 / 255); "B" = [math]::Floor(216 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黄色の羊毛(標)" = @{"R" = [math]::Floor(229 * 220 / 255); "G" = [math]::Floor(229 * 220 / 255); "B" = [math]::Floor(51 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黄緑色の羊毛(標)" = @{"R" = [math]::Floor(127 * 220 / 255); "G" = [math]::Floor(204 * 220 / 255); "B" = [math]::Floor(25 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"桃色の羊毛(標)" = @{"R" = [math]::Floor(242 * 220 / 255); "G" = [math]::Floor(127 * 220 / 255); "B" = [math]::Floor(165 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"灰色の羊毛(標)" = @{"R" = [math]::Floor(76 * 220 / 255); "G" = [math]::Floor(76 * 220 / 255); "B" = [math]::Floor(76 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"薄灰色の羊毛(標)" = @{"R" = [math]::Floor(153 * 220 / 255); "G" = [math]::Floor(153 * 220 / 255); "B" = [math]::Floor(153 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"青緑色の羊毛(標)" = @{"R" = [math]::Floor(76 * 220 / 255); "G" = [math]::Floor(127 * 220 / 255); "B" = [math]::Floor(153 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"紫色の羊毛(標)" = @{"R" = [math]::Floor(127 * 220 / 255); "G" = [math]::Floor(63 * 220 / 255); "B" = [math]::Floor(178 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"青色の羊毛(標)" = @{"R" = [math]::Floor(51 * 220 / 255); "G" = [math]::Floor(76 * 220 / 255); "B" = [math]::Floor(178 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"茶色の羊毛(標)" = @{"R" = [math]::Floor(102 * 220 / 255); "G" = [math]::Floor(76 * 220 / 255); "B" = [math]::Floor(51 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"緑色の羊毛(標)" = @{"R" = [math]::Floor(102 * 220 / 255); "G" = [math]::Floor(127 * 220 / 255); "B" = [math]::Floor(51 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"赤色の羊毛(標)" = @{"R" = [math]::Floor(153 * 220 / 255); "G" = [math]::Floor(51 * 220 / 255); "B" = [math]::Floor(51 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黒色の羊毛(標)" = @{"R" = [math]::Floor(25 * 220 / 255); "G" = [math]::Floor(25 * 220 / 255); "B" = [math]::Floor(25 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"金ブロック(標)" = @{"R" = [math]::Floor(250 * 220 / 255); "G" = [math]::Floor(238 * 220 / 255); "B" = [math]::Floor(77 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"ネザーラック(標)" = @{"R" = [math]::Floor(112 * 220 / 255); "G" = [math]::Floor(2 * 220 / 255); "B" = [math]::Floor(0 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"白色のテラコッタ(標)" = @{"R" = [math]::Floor(209 * 220 / 255); "G" = [math]::Floor(177 * 220 / 255); "B" = [math]::Floor(161 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"橙色のテラコッタ(標)" = @{"R" = [math]::Floor(159 * 220 / 255); "G" = [math]::Floor(82 * 220 / 255); "B" = [math]::Floor(36 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"赤紫色のテラコッタ(標)" = @{"R" = [math]::Floor(149 * 220 / 255); "G" = [math]::Floor(87 * 220 / 255); "B" = [math]::Floor(108 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"空色のテラコッタ(標)" = @{"R" = [math]::Floor(112 * 220 / 255); "G" = [math]::Floor(108 * 220 / 255); "B" = [math]::Floor(138 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黄色のテラコッタ(標)" = @{"R" = [math]::Floor(186 * 220 / 255); "G" = [math]::Floor(133 * 220 / 255); "B" = [math]::Floor(36 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黄緑色のテラコッタ(標)" = @{"R" = [math]::Floor(103 * 220 / 255); "G" = [math]::Floor(117 * 220 / 255); "B" = [math]::Floor(53 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"桃色のテラコッタ(標)" = @{"R" = [math]::Floor(160 * 220 / 255); "G" = [math]::Floor(77 * 220 / 255); "B" = [math]::Floor(78 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"灰色のテラコッタ(標)" = @{"R" = [math]::Floor(57 * 220 / 255); "G" = [math]::Floor(41 * 220 / 255); "B" = [math]::Floor(35 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"薄灰色のテラコッタ(標)" = @{"R" = [math]::Floor(135 * 220 / 255); "G" = [math]::Floor(107 * 220 / 255); "B" = [math]::Floor(98 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"青緑色のテラコッタ(標)" = @{"R" = [math]::Floor(87 * 220 / 255); "G" = [math]::Floor(92 * 220 / 255); "B" = [math]::Floor(92 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"紫色のテラコッタ(標)" = @{"R" = [math]::Floor(122 * 220 / 255); "G" = [math]::Floor(73 * 220 / 255); "B" = [math]::Floor(88 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"青色のテラコッタ(標)" = @{"R" = [math]::Floor(76 * 220 / 255); "G" = [math]::Floor(62 * 220 / 255); "B" = [math]::Floor(92 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"茶色のテラコッタ(標)" = @{"R" = [math]::Floor(76 * 220 / 255); "G" = [math]::Floor(50 * 220 / 255); "B" = [math]::Floor(35 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"緑色のテラコッタ(標)" = @{"R" = [math]::Floor(76 * 220 / 255); "G" = [math]::Floor(82 * 220 / 255); "B" = [math]::Floor(42 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"赤色のテラコッタ(標)" = @{"R" = [math]::Floor(142 * 220 / 255); "G" = [math]::Floor(60 * 220 / 255); "B" = [math]::Floor(46 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"黒色のテラコッタ(標)" = @{"R" = [math]::Floor(37 * 220 / 255); "G" = [math]::Floor(22 * 220 / 255); "B" = [math]::Floor(16 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"真紅のナイリウム(標)" = @{"R" = [math]::Floor(189 * 220 / 255); "G" = [math]::Floor(48 * 220 / 255); "B" = [math]::Floor(49 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"真紅の板材(標)" = @{"R" = [math]::Floor(148 * 220 / 255); "G" = [math]::Floor(63 * 220 / 255); "B" = [math]::Floor(97 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"真紅の菌糸(標)" = @{"R" = [math]::Floor(92 * 220 / 255); "G" = [math]::Floor(25 * 220 / 255); "B" = [math]::Floor(29 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"歪んだナイリウム(標)" = @{"R" = [math]::Floor(22 * 220 / 255); "G" = [math]::Floor(126 * 220 / 255); "B" = [math]::Floor(134 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"歪んだ板材(標)" = @{"R" = [math]::Floor(58 * 220 / 255); "G" = [math]::Floor(142 * 220 / 255); "B" = [math]::Floor(140 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"歪んだ菌糸(標)" = @{"R" = [math]::Floor(86 * 220 / 255); "G" = [math]::Floor(44 * 220 / 255); "B" = [math]::Floor(62 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"歪んだネザーウォートブロック(標)" = @{"R" = [math]::Floor(20 * 220 / 255); "G" = [math]::Floor(180 * 220 / 255); "B" = [math]::Floor(133 * 220 / 255)}}) | Out-Null
    ...
    $Ret.Add(@{"深層岩(標)" = @{"R" = [math]::Floor(100 * 220 / 255); "G" = [math]::Floor(100 * 220 / 255); "B" = [math]::Floor(100 * 220 / 255)}}) | Out-Null
...
if(Test-Path -Path "${Directory}\${BaseName}_${TargetWidth}.png"){
    Remove-Item -Path "${Directory}\${BaseName}_${TargetWidth}.png"
}
$DstBitmap.Save("${Directory}\${BaseName}_${TargetWidth}.png", [System.Drawing.Imaging.ImageFormat]::Png)
...
$MinecraftBitmap.Save("${Directory}\${BaseName}_MC.png", [System.Drawing.Imaging.ImageFormat]::Png)
